# **Referencia rápida para la placa Arduino Uno**

## CONFIGURACIÓN DE PINES Y SUS RESPECTIVAS FUNCIONES

![Alt text](./../../../assets/images/Arduino-Uno.jpg)
...
Los nombres de los pines digitales se denominan a partir de `d0` hasta `d19`.
...
### Canales analógicos
Los canales PWM fueron nombrados desde `ch0` hasta`ch5`.
